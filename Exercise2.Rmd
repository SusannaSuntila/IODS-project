...
- Use `dim()` on the data frame to look at the dimensions of the data. How many rows and colums does the data have? **there are 183 rows and 60 columns**
...
pairs(learning2014[-1], col = c("cornflowerblue")[learning2014$gender])
...
# adjust the plot by defining col = gender
p1 <- ggpairs(learning2014, mapping = aes(col = gender), lower = list(combo = wrap("facethist", bins = 20)))

# draw the plot
p1

# adjust the plot by adding alpha = 0.3
...
# add the surf variable in the model
